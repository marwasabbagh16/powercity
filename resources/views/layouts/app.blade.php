...
<div>
    ...
    <ul class="space-y-2 max-h-64 overflow-y-auto pr-2">
        ...
        <li><a href="{{ route('categories.show', 17) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Disjoncteur modulaire
        </a></li>
        <li><a href="{{ route('categories.show', 18) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Interrupteur modulaire
        </a></li>
        <li><a href="{{ route('categories.show', 19) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Interrupteur modulaire différentiel
        </a></li>
        <li><a href="{{ route('categories.show', 20) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Contacteurs modulaires
        </a></li>
        <li><a href="{{ route('categories.show', 21) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Minutrie sur rail
        </a></li>
        <li><a href="{{ route('categories.show', 22) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Télérupteur
        </a></li>
        <li><a href="{{ route('categories.show', 23) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Disjoncteur compact
        </a></li>
        <li><a href="{{ route('categories.show', 24) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Interrupteur compact
        </a></li>
        <li><a href="{{ route('categories.show', 25) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
            <i data-lucide="chevron-right" class="w-3 h-3" style="color:#4caf50"></i> Contacteurs de puissance
        </a></li>
        <li><a href="{{ route('categories.show', 26) }}" class="text-sm text-gray-600 hover:text-primary flex items-center gap-2 transition">
