...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/logoo.png') }}" class="h-10 w-auto">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-2 text-sm font-medium">
                ...
                <div class="relative dropdown">
                    <button class="nav-link text-gray-600 hover:text-primary transition px-3 py-2 rounded-lg hover:bg-gray-50 flex items-center gap-1 {{ request()->routeIs('products.*') || request()->routeIs('categories.*') ? 'active' : '' }}">
                        Produits
